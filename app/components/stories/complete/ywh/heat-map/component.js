...
export default DefaultStory.extend({
    ...
    onDidInsertElement: function(){
        // $.getScript('https://maps.googleapis.com/maps/api/js?signed_in=true&libraries=visualization&callback=initMap');
        // this.$.getScript('https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&signed_in=true&libraries=visualization&callback=initMap');
