...
export default Ember.Component.extend({
	...
	isAdmin: function () {
		var adminHosts = ['localhost', '127.0.0.1', '0.0.0.0', 'testing.mysolomon.co.uk', 'preview.mysolomon.co.uk','yorkshirewater.mysolomon.co.uk', 'preview.leeds.mysolomon.co.uk', 'mysolomon-yorkshirewater-preview.azurewebsites.net'];
